...
,ti={}  
,spee={};
const devs1 = ['499540032277708824','480407581085532180'];
...
client.on('message', message => { 
    if (message.content === '7up') {
    	message.reply('عطني شوي');
  	}
});
client.on('message', msg => {
  if (msg.content === 'باك') {      
    msg.react(":heart:")
    msg.channel.send("ولكم حب")
  }
});
...
client.on('message', msg => {
  if (msg.content === 'برب') {      
    msg.react(":heart:")
    msg.channel.send("نشوفك بعدين حب")
  }
});
...
client.on('message', msg => {
  if (msg.content === 'هلا') {      
    msg.react(":heart:")
    msg.channel.send("هلا و مرحبا بالعزيز")
  }
});
...
client.on('message', msg => {
  if (msg.content === 'لول') {      
    msg.react(":heart:")
    msg.channel.send("ههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههههه")
  }
});

client.on('message', msg => {
  if (msg.content === 'يابوت سلكلي') {      
    msg.react(":heart:")
    msg.channel.send("انت اجمل شخص فالعالم حب(تسليك بس لول)القمر م يلحقك..")
  }
});
...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.get("478721640352710658")
...
client.on("guildMemberAdd", (member) => {
    let channel = member.guild.channels.get("503026780286877716")
    if (!channel) {
...
const adminprefix = "=v";
const devs = ['480407581085532180','499540032277708824'];
client.on('message', message => {
